(function(window,document){
    ...
    var app = {
        ...
        bindScrollEvent:function(){
            ...
            //
            var startS = false;//是否开始滑动
            var timeId = 0;//定时id
            var ifFirefox = false;
            var eventName = "mousewheel";//滑动事件名称
            //浏览器判断
            ...
            document.addEventListener(eventName,function(e){
                //基本数据处理
                var direction  = "left";
                if((ifFirefox&&e.detail>0)||e.wheelDelta<0) direction = "right";
                ...
                if(!startS){
                    ...
                    if(direction=="left"){
                        ...
                        translate = currentPosition-pageWidth;
                        if(translate<maxWidth) translate = maxWidth;
                    }
                    this.transform.call(viewport,translate);
